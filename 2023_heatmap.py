...
world_heatmap.plot(column='Value', ax=ax, cmap=plt.cm.colors.ListedColormap(['white', 'blue']), linewidth=0.8, edgecolor='black')

# Coordinates for Singapore
singapore_coords = (103.8198, 1.3521) # Longitude, Latitude

# Add a red dot for Singapore
ax.scatter(singapore_coords[0], singapore_coords[1], color='blue', s=100) # s is the size of the marker
...
# Show the plot
plt.savefig('/Users/spencerkline/Documents/2023.png', dpi=300, bbox_inches='tight')
