...
# Load the Excel file
heatmap_data = pd.read_excel(file_path, sheet_name='2024', engine='openpyxl')
...
# Set a title
plt.title('TeleMedC 2024 Presence')

# Show the plot
plt.savefig('/Users/spencerkline/Documents/2024.png', dpi=300, bbox_inches='tight')
